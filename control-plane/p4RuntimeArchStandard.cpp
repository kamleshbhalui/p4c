...
template <Arch arch, bool = !(arch==Arch::DPDK_PSA || arch == Arch::DPDK_PNA)>
...
/// serialize PSA and PNA specific symbols which are exposed to the control-plane.
template <Arch arch>
class P4RuntimeArchHandlerPSAPNA<arch, false> : public P4RuntimeArchHandlerCommon<arch> {
 public:
    P4RuntimeArchHandlerPSAPNA(ReferenceMap* refMap,
                            TypeMap* typeMap,
                            const IR::ToplevelBlock* evaluatedProgram)
...
class P4RuntimeArchHandlerDPDKPSA final : public P4RuntimeArchHandlerPSAPNA<Arch::DPDK_PSA> {
 public:
    P4RuntimeArchHandlerDPDKPSA(ReferenceMap* refMap,
                             TypeMap* typeMap,
                             const IR::ToplevelBlock* evaluatedProgram)
            : P4RuntimeArchHandlerPSAPNA(refMap, typeMap, evaluatedProgram) {
     }
...
P4RuntimeArchHandlerIface*
DPDKPSAArchHandlerBuilder::operator()(
    ReferenceMap* refMap, TypeMap* typeMap, const IR::ToplevelBlock* evaluatedProgram) const {
    return new P4RuntimeArchHandlerDPDKPSA(refMap, typeMap, evaluatedProgram);
}
...
class P4RuntimeArchHandlerDPDKPNA final : public P4RuntimeArchHandlerPSAPNA<Arch::DPDK_PNA> {
 public:
    P4RuntimeArchHandlerDPDKPNA(ReferenceMap* refMap,
                             TypeMap* typeMap,
                             const IR::ToplevelBlock* evaluatedProgram)
            : P4RuntimeArchHandlerPSAPNA(refMap, typeMap, evaluatedProgram) {
     }
...
P4RuntimeArchHandlerIface*
DPDKPNAArchHandlerBuilder::operator()(
        ReferenceMap* refMap, TypeMap* typeMap, const IR::ToplevelBlock* evaluatedProgram) const {
    return new P4RuntimeArchHandlerDPDKPNA(refMap, typeMap, evaluatedProgram);
}
