...
parser ParserI(packet_in b, out H parsedHdr, inout M meta, in psa_ingress_parser_input_metadata_t x,
...
control DeparserI(packet_out b, out EMPTY_CLONE clone_i2e_meta,
