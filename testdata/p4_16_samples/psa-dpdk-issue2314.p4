...
parser MyParser(packet_in b, out h hdr, inout m meta, in psa_ingress_parser_input_metadata_t x,
...
control MyIngress(inout h hdr, inout m meta, in psa_ingress_input_metadata_t istd,
