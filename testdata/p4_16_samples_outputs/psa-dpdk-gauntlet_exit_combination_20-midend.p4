...
control ingress(inout Headers h, inout Meta m, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    ...
    @hidden action psadpdkgauntlet_exit_combination_20l62() {
    ...
    @hidden table tbl_psadpdkgauntlet_exit_combination_20l62 {
        actions = {
            psadpdkgauntlet_exit_combination_20l62();
        }
        const default_action = psadpdkgauntlet_exit_combination_20l62();
    }
    apply {
        tbl_simple_action.apply();
        tbl_psadpdkgauntlet_exit_combination_20l62.apply();
    }
}
...
control deparser(packet_out pkt, out EMPTY_CLONE clone_i2e_meta, out EMPTY_RESUB resubmit_meta, out EMPTY_BRIDGE normal_meta, inout Headers hdr, in Meta local_metadata, in psa_ingress_output_metadata_t istd) {
    @hidden action psadpdkgauntlet_exit_combination_20l83() {
        pkt.emit<ethernet_t>(hdr.eth_hdr);
    }
    @hidden table tbl_psadpdkgauntlet_exit_combination_20l83 {
        actions = {
            psadpdkgauntlet_exit_combination_20l83();
        }
        const default_action = psadpdkgauntlet_exit_combination_20l83();
    }
    apply {
        tbl_psadpdkgauntlet_exit_combination_20l83.apply();
    }
}
