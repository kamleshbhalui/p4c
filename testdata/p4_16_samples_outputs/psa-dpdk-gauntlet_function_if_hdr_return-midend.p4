...
control ingress(inout Headers h, inout Meta m, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    ...
    @hidden action psadpdkgauntlet_function_if_hdr_return27() {
        retval.setValid();
    ...
    @hidden table tbl_psadpdkgauntlet_function_if_hdr_return27 {
        actions = {
            psadpdkgauntlet_function_if_hdr_return27();
        }
        const default_action = psadpdkgauntlet_function_if_hdr_return27();
    }
    apply {
        tbl_psadpdkgauntlet_function_if_hdr_return27.apply();
    }
}
...
control deparser(packet_out pkt, out EMPTY_CLONE clone_i2e_meta, out EMPTY_RESUB resubmit_meta, out EMPTY_BRIDGE normal_meta, inout Headers h, in Meta local_metadata, in psa_ingress_output_metadata_t istd) {
    @hidden action psadpdkgauntlet_function_if_hdr_return82() {
        pkt.emit<ethernet_t>(h.eth_hdr);
    }
    @hidden table tbl_psadpdkgauntlet_function_if_hdr_return82 {
        actions = {
            psadpdkgauntlet_function_if_hdr_return82();
        }
        const default_action = psadpdkgauntlet_function_if_hdr_return82();
    }
    apply {
        tbl_psadpdkgauntlet_function_if_hdr_return82.apply();
    }
}
