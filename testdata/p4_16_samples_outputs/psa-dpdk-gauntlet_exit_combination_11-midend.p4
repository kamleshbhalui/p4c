...
control ingress(inout Headers h, inout Meta m, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    ...
    @hidden action psadpdkgauntlet_exit_combination_11l69() {
        h.eth_hdr.eth_type = 16w1;
    }
    @hidden action psadpdkgauntlet_exit_combination_11l60() {
        hasExited = false;
        key_0 = 64w1;
    }
    @hidden action psadpdkgauntlet_exit_combination_11l74() {
        hasExited = true;
    }
    @hidden table tbl_psadpdkgauntlet_exit_combination_11l60 {
        actions = {
            psadpdkgauntlet_exit_combination_11l60();
        }
        const default_action = psadpdkgauntlet_exit_combination_11l60();
    }
    @hidden table tbl_psadpdkgauntlet_exit_combination_11l69 {
        actions = {
            psadpdkgauntlet_exit_combination_11l69();
        }
        const default_action = psadpdkgauntlet_exit_combination_11l69();
    }
    @hidden table tbl_psadpdkgauntlet_exit_combination_11l74 {
        actions = {
            psadpdkgauntlet_exit_combination_11l74();
        }
        const default_action = psadpdkgauntlet_exit_combination_11l74();
    }
    apply {
        tbl_psadpdkgauntlet_exit_combination_11l60.apply();
        switch (simple_table_0.apply().action_run) {
            simple_action: {
                if (hasExited) {
                    ;
                } else {
                    tbl_psadpdkgauntlet_exit_combination_11l69.apply();
                }
            }
            default: {
            }
        ...
        if (hasExited) {
            ...
            tbl_psadpdkgauntlet_exit_combination_11l74.apply();
        }
    }
}
...
control deparser(packet_out pkt, out EMPTY_CLONE clone_i2e_meta, out EMPTY_RESUB resubmit_meta, out EMPTY_BRIDGE normal_meta, inout Headers h, in Meta local_metadata, in psa_ingress_output_metadata_t istd) {
    @hidden action psadpdkgauntlet_exit_combination_11l95() {
        pkt.emit<ethernet_t>(h.eth_hdr);
    }
    @hidden table tbl_psadpdkgauntlet_exit_combination_11l95 {
        actions = {
            psadpdkgauntlet_exit_combination_11l95();
        }
        const default_action = psadpdkgauntlet_exit_combination_11l95();
    }
    apply {
        tbl_psadpdkgauntlet_exit_combination_11l95.apply();
    }
}
